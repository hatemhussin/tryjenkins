Teaspoon.configure do |config|
  ...
  config.suite :test_suite do |suite|
    suite.matcher = "{spec/javascripts/tests}/**/*_spec.{js,js.coffee,coffee}"
  end
  ...
  config.coverage :test_suite do |coverage|
    coverage.ignore = [%r{/lib/ruby/gems/}, %r{^((?!javascripts\/tests).)*$} ]
  end
end
